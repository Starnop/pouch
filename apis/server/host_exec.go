...
func (s *Server) HostExecHandler(ctx context.Context, w http.ResponseWriter, r *http.Request) (err error) {
	defer func() {
...
func (s *Server) HostExecResultHandler(ctx context.Context, w http.ResponseWriter, r *http.Request) (err error) {
	defer func() {
		if err := recover(); err != nil {
			logrus.Errorf("host exec result recover from %v", err)
		}
