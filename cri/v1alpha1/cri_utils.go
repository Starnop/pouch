...
func parseResourcesFromAPI(runtimeResources *runtime.LinuxContainerResources) apitypes.Resources {
	...
	return apitypes.Resources{
		...
		BlkioWeightDevice:    parseWeightDeviceFromAPI(runtimeResources.GetBlkioWeightDevice()),
		BlkioDeviceReadBps:   parseThrottleDeviceFromAPI(runtimeResources.GetBlkioDeviceReadBps()),
		BlkioDeviceWriteBps:  parseThrottleDeviceFromAPI(runtimeResources.GetBlkioDeviceWriteBps()),
		BlkioDeviceReadIOps:  parseThrottleDeviceFromAPI(runtimeResources.GetBlkioDeviceRead_IOps()),
		BlkioDeviceWriteIOps: parseThrottleDeviceFromAPI(runtimeResources.GetBlkioDeviceWrite_IOps()),
		KernelMemory:         runtimeResources.GetKernelMemory(),
		MemoryReservation:    runtimeResources.GetMemoryReservation(),
		MemorySwappiness:     memorySwappiness,
		Ulimits:              parseUlimitFromAPI(runtimeResources.GetUlimits()),
	}
}
...
func parseWeightDeviceFromAPI(runtimeWeightDevices []*runtime.WeightDevice) (weightDevices []*apitypes.WeightDevice) {
...
// parseThrottleDeviceFromAPI parse ThrottleDevice from runtime.ThrottleDevice to apitypes.ThrottleDevice
func parseThrottleDeviceFromAPI(runtimeThrottleDevices []*runtime.ThrottleDevice) (throttleDevices []*apitypes.ThrottleDevice) {
...
func parseUlimitFromAPI(runtimeUlimits []*runtime.Ulimit) (ulimits []*apitypes.Ulimit) {
