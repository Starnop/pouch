...
func validateResource(r *types.Resources, update bool) ([]string, error) {
	...
	if cgroupInfo.Memory != nil {
		...
		if r.MemorySwappiness != nil && (*r.MemorySwappiness < 0 || *r.MemorySwappiness > 100) && *r.MemorySwappiness != -1 {
			return warnings, fmt.Errorf("MemorySwappiness should in range [0, 100], or -1")
		}
